...
import PlantUMLWorkbench.eclipse.utils.LocationDiagramIntentProviderContext;
...
public abstract class AbstractDiagramSourceView extends ViewPart {
	...
	protected boolean isPlantUmlView(final String partId) {
		return partId.startsWith("PlantUMLWorkbench.eclipse.views.");
	}
